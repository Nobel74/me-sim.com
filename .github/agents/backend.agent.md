...
* StrongeSIM: Lee el archivo `.github/agents/knowledge/strongesim.md` para contratos de endpoints, tipos de datos (`plan_id` entero), payloads de compra y manejo de tokens.
* WooCommerce: Consulta `.github/agents/knowledge/woocommerce.md` para gestión de pedidos, metadatos y cupones.
* Stripe: Consulta `.github/agents/knowledge/stripe.md` para el ciclo de vida de PaymentIntents y webhooks.