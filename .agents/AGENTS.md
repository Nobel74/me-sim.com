...
- **Economía de paddings**: Cuando estemos en la versión móvil todos los contenedores de texto en el body deben tener 5px de padding por la izquierda y por la derecha, esto no debe afectar a las tarjetas donde hay contenido en sí, pero dentro de las tarjetas también aplicaremos esos 5px de padding a la izquierda y derecha.