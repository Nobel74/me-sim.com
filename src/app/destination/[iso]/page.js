    ...
    <div className="container-naked max-w-5xl font-sans">
      ...
      <div className="bg-white rounded-3xl border border-zinc-200 p-6 md:p-8 mb-10 shadow-xl grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        <div className="relative rounded-3xl overflow-hidden h-80 md:h-[400px] shadow-md">
          ...
          />
          <div className="absolute bottom-4 left-4 bg-black/85 backdrop-blur-md text-[#ffec00] text-xs font-semibold font-condensed tracking-wide px-4 py-2 rounded-full flex items-center gap-2 shadow-md">
            📍 {landmarkName}
          </div>
        </div>
        ...
        <div>
          ...
          {/* 3 Flat Feature Cards Direct Layout (No outer border wrapper for max space) */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {/* Feature 1: QR en segundos */}
            <div className="bg-white p-4 rounded-2xl border border-zinc-200 shadow-sm flex items-center gap-3.5 hover:border-black transition-all">
              <div className="w-10 h-10 rounded-xl bg-[#ffec00] text-black flex items-center justify-center flex-shrink-0 shadow-xs">
                <svg className="w-5.5 h-5.5 fill-current text-black" viewBox="0 0 24 24">
              ...
              <span className="font-semibold font-semi text-black text-sm md:text-base leading-tight">
      ...
      {/* Plan Selector Section with 2-Column Filter Layout */}
